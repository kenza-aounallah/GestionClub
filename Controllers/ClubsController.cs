...
namespace ClubsGestionLastVersion.Controllers
{
    public class ClubsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ClubId,Nom,Description")] Club club)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClubId,Nom,Description")] Club club)
        {
            if (id != club.ClubId)
            {
                return NotFound();
